...
public interface DatabaseInfo {
    ...
    public static String DBURL = "jdbc:sqlserver://35.240.216.150;databaseName=Travelink;encrypt=false;trustServerCertificate=false;loginTimeout=30;";
    public static String USERDB = "sqlserver";
    public static String PASSDB = "bin170421";
