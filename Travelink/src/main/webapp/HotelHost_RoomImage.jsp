...
<html>
    ...
    <body>
        ...
        <div class="container-fluid">
            <a href="homeHotelHostServlet" class="btn btn-outline-primary mt-2"><img src="img_Hotel/back.svg" alt="Special Icon" style="width: 1rem; height: 1rem;" class="me-2">Back</a>
                        ...
                        <div class="card-body">
                            <table id="hotelTable" class="table-hover table align-items-center justify-content-center">
                                <thead>
                                    <tr class="text-center">
                                        ...
                                        <th scope="col-md-3">IMAGE ID</th>
                                        <th scope="col-md-6">IMAGE</th>
                                        <th scope="col-md-2">ACTION</th>
                                    </tr>
                                </thead>
                                <c:forEach var="h" items="${requestScope.list_images}" varStatus="loopStatus">
                                    <tbody class="table-group-divider align-items-center text-center mt-2 justify-content-center">
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="row m-2">
                                                    <a class="btn btn-outline-primary delete-button" href="#" 
                                                       data-image-id="${h.room_Image_ID}">
                                                        Delete
                                                    </a>
                                                </div>
                            ...
                            <div class="row m-2">
                                <div class="form-group mb-2">
                                    ...
                                    <input type="text" class="form-control" id="newRoomID" name="roomID" value="${requestScope.room_ID}" readonly="">
                                </div>
                                <!-- Form upload image -->
                                <form method="post" action="UploadImageAvatar" enctype="multipart/form-data" onsubmit="return validateForm(event)">
                                    ...
                                    <input type="hidden" name="uploadhotelhost" value="2.3"/>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="updateModalLabel-${h.room_Image_ID}">Update Room Image</h5>
                        ...
                        <div class="modal-body">
                            ...
                            <!-- Form upload image -->
                            <form method="post" action="UploadImageAvatar" enctype="multipart/form-data" id="uploadForm-${h.room_Image_ID}" onsubmit="return validateForm(event, ${h.room_Image_ID})">
                                <input type="file" id="file-${h.room_Image_ID}" name="file" size="60" accept=".jpeg,.jpg,.png" onchange="previewImage(event, ${h.room_Image_ID})"/><br/>
                                <p>Maximum file size is 1 MB.<br>Format: .JPEG, .PNG</p>
                                <div class="image-preview-container" id="preview-${h.room_Image_ID}">
                                    <!-- Image preview will be displayed here -->
                                </div>
                                <input id="submit_Input-${h.room_Image_ID}" style="margin-top:10px" type="submit" value="Upload"/>
                                <div id="error-message-${h.room_Image_ID}">Please select a file to upload.</div>
                                <input type="hidden" name="uploadhotelhost" value="2.2"/>
                                <input type="hidden" name="roomID" value="${h.room_ID}"/>
                                <input type="hidden" name="roomImageID" value="${h.room_Image_ID}"/>
                            </form>  
                            ...
                            <form method="post" action="UpdateAvatar">
                                <c:choose>
                                    ...
                                    <c:otherwise>
                                        <input type="hidden" name="urlAvatar" value=""/>
                                        <div class="pd_button">
                                            <button type="button" class="btn btn-secondary" style="pointer-events: none; cursor: not-allowed; opacity: 0.6;" data-dismiss="modal">Cancel</button>
                                            <input type="submit" value="Save" style="pointer-events: none; cursor: not-allowed; opacity: 0.6;"/>
                                        </div>
                                    </c:otherwise>
                                </c:choose>
